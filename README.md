...
##  FASE 1:
Primero se importaron las librerías necesarias para conectarse a la API de Spotify y obtener datos, se usó pandas para organizar y analizar esa información en tablas, y se definieron los parámetros del análisis: cinco géneros, (indie rock, jazz, funk, pop latino y reggeaton, y sus subgéneros) todos en el rango de años de 2010 a 2024.
...
•	Se hizo un merge con df_lastfm para agregar biografía, playcount y oyentes de los artistas, pues es librería contiene esa información.
...
•	sqlalchemy + mysqlclient: alternativa más robusta, especialmente útil para trabajar con pandas y manejar bases de datos de forma más eficiente.
